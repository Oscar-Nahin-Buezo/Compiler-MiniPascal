...
public interface PascalListener extends ParseTreeListener {
	 ...
	 * labeled alternative in {@link PascalParser#unsignedNumber}.
	 * @param ctx the parse tree
	 */
	void enterExprIntegerVal(PascalParser.ExprIntegerValContext ctx);
	/**
	 * Exit a parse tree produced by the {@code exprIntegerVal}
	 * labeled alternative in {@link PascalParser#unsignedNumber}.
	 * @param ctx the parse tree
	 */
	void exitExprIntegerVal(PascalParser.ExprIntegerValContext ctx);
	/**
	 * Enter a parse tree produced by the {@code exprRealVal}
	 * labeled alternative in {@link PascalParser#unsignedNumber}.
	 * @param ctx the parse tree
	 */
	void enterExprRealVal(PascalParser.ExprRealValContext ctx);
	/**
	 * Exit a parse tree produced by the {@code exprRealVal}
	 * labeled alternative in {@link PascalParser#unsignedNumber}.
	 * @param ctx the parse tree
	 */
	void exitExprRealVal(PascalParser.ExprRealValContext ctx);
	/**
	 ...
	 * @param ctx the parse tree
	 */
	void enterExprTrue(PascalParser.ExprTrueContext ctx);
	/**
	 * Exit a parse tree produced by the {@code exprTrue}
	 * labeled alternative in {@link PascalParser#bool_}.
	 * @param ctx the parse tree
	 */
	void exitExprTrue(PascalParser.ExprTrueContext ctx);
	/**
	 * Enter a parse tree produced by the {@code exprFalse}
	 * labeled alternative in {@link PascalParser#bool_}.
	 * @param ctx the parse tree
	 */
	void enterExprFalse(PascalParser.ExprFalseContext ctx);
	/**
	 * Exit a parse tree produced by the {@code exprFalse}
	 * labeled alternative in {@link PascalParser#bool_}.
	 * @param ctx the parse tree
	 */
	void exitExprFalse(PascalParser.ExprFalseContext ctx);
	/**
	 ...
	 * @param ctx the parse tree
	 */
	void enterTALVEZSTRUCTNAOSEI(PascalParser.TALVEZSTRUCTNAOSEIContext ctx);
	/**
	 * Exit a parse tree produced by the {@code TALVEZSTRUCTNAOSEI}
	 * labeled alternative in {@link PascalParser#typeIdentifier}.
	 * @param ctx the parse tree
	 */
	void exitTALVEZSTRUCTNAOSEI(PascalParser.TALVEZSTRUCTNAOSEIContext ctx);
	/**
	 * Enter a parse tree produced by the {@code charType}
	 * labeled alternative in {@link PascalParser#typeIdentifier}.
	 * @param ctx the parse tree
	 */
	void enterCharType(PascalParser.CharTypeContext ctx);
	/**
	 * Exit a parse tree produced by the {@code charType}
	 * labeled alternative in {@link PascalParser#typeIdentifier}.
	 * @param ctx the parse tree
	 */
	void exitCharType(PascalParser.CharTypeContext ctx);
	/**
	 ...
	 * @param ctx the parse tree
	 */
	void enterStrType(PascalParser.StrTypeContext ctx);
	/**
	 * Exit a parse tree produced by the {@code strType}
	 * labeled alternative in {@link PascalParser#typeIdentifier}.
	 * @param ctx the parse tree
	 */
	void exitStrType(PascalParser.StrTypeContext ctx);
	/**
	 ...
	 * labeled alternative in {@link PascalParser#unsignedConstant}.
	 * @param ctx the parse tree
	 */
	void enterNone(PascalParser.NoneContext ctx);
	/**
	 * Exit a parse tree produced by the {@code none}
	 * labeled alternative in {@link PascalParser#unsignedConstant}.
	 * @param ctx the parse tree
	 */
	void exitNone(PascalParser.NoneContext ctx);
	/**
	 * Enter a parse tree produced by the {@code exprStrVal}
	 * labeled alternative in {@link PascalParser#unsignedConstant}.
	 * @param ctx the parse tree
	 */
	void enterExprStrVal(PascalParser.ExprStrValContext ctx);
	/**
	 * Exit a parse tree produced by the {@code exprStrVal}
	 * labeled alternative in {@link PascalParser#unsignedConstant}.
	 * @param ctx the parse tree
	 */
	void exitExprStrVal(PascalParser.ExprStrValContext ctx);
	/**
